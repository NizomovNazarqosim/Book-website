...
export const LoginForm = () => {
    ...
    const onSubmit: SubmitHandler<ISignInForm> = (data) => window.location.href='/books';
  ...
  return (
    ...
    <div className='auth-form'>
        ...
        <Button style={{marginBottom:'10px'}} fullWidth={true} className='icon-wrapper' variant='outlined' onClick={() => { alert('clicked');}}>
       ...
       <div className="lines">
        ...
        <p>Already signed up? <Link to='/'>Go to sign in.</Link></p>
    </div>
    </div>
  )
}
